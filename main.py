...
def detect_intent(message):
    ...
    # 🧠 NEW: MEMORY QUERY INTENT (MARK12)
    if any(x in msg for x in ["antes", "dijiste", "recuerdas", "qué me", "qué dije", "qué quiero"]):
        return "memory_query"
...
# 🧠 MEMORY SEARCH ENGINE (MARK12 CORE)
...
def jarvis_response(message):
    ...
    # 🧠 MEMORY QUERY ENGINE (NUEVO MARK12)
    if intent == "memory_query":
        ...
        # fallback cloud
        if cloud_context:
            return f"🧠 Recuerdo aproximado desde nube: {cloud_context}"
